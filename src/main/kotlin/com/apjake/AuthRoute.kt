...
import com.apjake.authenticate
...
fun Route.signUp(
    ...
    post("signup") {
        ...
        val isPswTooShort = request.password.length < 6
        if (areFieldsBlank || isPswTooShort) {
...
fun Route.getSecretInfo() {
    authenticate {
        get("secret") {
            ...
            call.respond(HttpStatusCode.OK, message = "Your user ID is $userId")
        }
    }
}